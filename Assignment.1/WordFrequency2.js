vvar buttons = [
  "women", "health", "children", "job",
  "livelihoods", "education",
],
  word = buttons[6], buttonX = 150, over, data, kwic, input;

function preload() {

  data = loadStrings('AfricaRenewableEnergy.txt');
}
...
function updateKWIC() {
  ...
  if (kwic.length == 0) {
    ...
    text("Press Button For Analysis", width / 2, height / 2);
